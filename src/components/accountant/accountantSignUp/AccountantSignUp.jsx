...
import "./login.css";
import { getUser, signUpAccountant } from "../../../redux/actions/userActions";
...
class AccountantSignUp extends React.Component {
  constructor() {
    super();
    this.state = {
      email: "",
...
export default connect(mapStateToProps, mapActionsToProps)(AccountantSignUp);
